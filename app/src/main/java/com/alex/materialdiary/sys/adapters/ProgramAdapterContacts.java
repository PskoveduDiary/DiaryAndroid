...
public class ProgramAdapterContacts extends ArrayAdapter<String> {
    ...
    public ProgramAdapterContacts(ContactsFragment context, List<String> Logins, List<String> Names, List<Integer> Unreaded, List<Boolean> isGroup) {
        super(context.getContext(), R.layout.single_contact, R.id.NameofContact, Names);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        singleItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.openMsg(Names.get(position), Logins.get(position), isGroup.get(position));
